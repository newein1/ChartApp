                        ...
                        try {
                            ...
                            if (!mmSocket.isConnected()){
                                try{
                                    mmSocket.connect();
                                    connected = true;
                                    Toast.makeText(Bluetooth_test.this, adapter.getItem(position).toString(), Toast.LENGTH_SHORT).show();
                                }
                                catch(IOException e) {
                                    // TODO Auto-generated catch block
                                    e.printStackTrace();
                                    Toast.makeText(Bluetooth_test.this, "device cannot be connected", Toast.LENGTH_SHORT).show();
                                }
                            }
                        } catch (IOException e) {
                            // TODO Auto-generated catch block
